...
from src.synaesthesia.collates import BatchCollate

from .simple_csv_dataset import SimpleCsvDataset
from .test_utils import CustomMultiSignalDataset, CustomSequentialSignalDataset
...
def test_simple_sequential_data():
    ...
    dataset = CustomSequentialSignalDataset(dataset, 3)
